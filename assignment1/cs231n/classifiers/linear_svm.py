...
def svm_loss_vectorized(W, X, y, reg):
    ...
    # loss.                                                                     #
    #############################################################################
    deriv_matrix = np.zeros((num_train, num_classes))
    deriv_matrix[margins > 0] = 1
    deriv_matrix[np.arange(num_train), list(y)] = -np.sum(deriv_matrix, axis=1)
    dW = np.dot(X.T, deriv_matrix)
    dW /= num_train + reg * W
    #############################################################################
    #                             END OF YOUR CODE                              #
    #############################################################################
